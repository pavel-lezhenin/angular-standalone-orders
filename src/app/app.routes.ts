    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('../areas/landing/components/landing.component').then((m) => m.LandingComponent),
        ...
        children: [
          {
            ...
            loadComponent: () =>
              import('../areas/orders/order-history/order-history.component').then(
          ...
          },
          {
            ...
            loadComponent: () =>
              import('../areas/orders/cart/cart.component').then((m) => m.default),
            title: 'Shopping Cart',
          },
          {
            path: 'checkout',
            ...
            loadComponent: () =>
              import('../areas/orders/checkout/checkout.component').then((m) => m.default),
            title: 'Checkout',
          },
          {
            path: 'payment',
            ...
            loadComponent: () =>
              import('../areas/orders/payment/payment.component').then((m) => m.default),
            title: 'Payment',
          },
          {
            path: 'details/:id',
            canActivate: [authGuard],
            loadComponent: () =>
              import('../areas/orders/order-confirmation/order-confirmation.component').then(
                (m) => m.default
              ),
            title: 'Order Details',
          },
      ...
      },
      {
        ...
        loadComponent: () =>
          import('../areas/shop/shop-product-detail/shop-product-detail.component').then(
            (m) => m.default
          ),
      ...
      },
      {
        ...
        canActivate: [authGuard],
        loadComponent: () =>
          import('../areas/account/account.component').then((m) => m.AccountComponent),
